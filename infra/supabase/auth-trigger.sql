-- Mirrors Supabase Auth identities into the application-level User table.
-- Run after the Prisma migration in the Supabase SQL editor.
...
DROP TRIGGER IF EXISTS on_braincrew_auth_user_changed ON auth.users;
CREATE TRIGGER on_braincrew_auth_user_changed
